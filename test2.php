                        ...
                        <ul class="menuitem">
                            ...
                            <li style="">
                                ...
                                <div style="background: #f00">
                                    <img src="img/logos/point.jpeg" style="float:left;margin-bottom:10px;width:100%"/>
                                </div>
                                <div style="clear:both"></div>
                                <a><span class="menu-text"><b>KPA CENTRAL BRANCH</span></a></b>
                            </li>
...
<script type="text/javascript">
    var comname = 'KPA CENTRAL BRANCH';
...
<script type="text/javascript">
    //$('#mainp').css("background", "url('img/watermarks/point.png') no-repeat center");
    //dashboard();
    //updatescript();
    refreshnotif();
</script>
