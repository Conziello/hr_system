$(document).ready(function() {
			...
			var fileReader = new FileReader();
				...
				fileReader.onload = (function(file) {
					...
					return function(e) { 
						...
						dataArray.push({name : fname, value : this.result, stamp:stamp});
	...
	if (!files[index].type.match('image.*')) {
				$('#dropped-files').append('<div class="image" style="left: '+z+'px; background:url(images/adobe.png); background-size: cover;"> </div>'); 
						}else{
	...
	$('#upload-button .upload').click(function() {
		...
		$.each(dataArray, function(index, file) {	
			...
			$.post('docupload.php', dataArray[index], function(data) {
